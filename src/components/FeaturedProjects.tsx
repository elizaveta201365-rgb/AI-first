...
const projects = [
  {
    id: "studyflow",
    title: "StudyFlow",
    description: "AI-платформа для персонализированного обучения. Адаптирует учебные планы под каждого студента и ускоряет подготовку в 2 раза.",
    tags: ["React", "OpenAI", "Python", "Tailwind"],
    icon: Sparkles,
    accent: "#2d5a4a",
  },
  {
    id: "neuroanalyst",
    title: "НейроАналитик",
    description: "AI-сервис для анализа данных. Превращает сырые датасеты в наглядные отчёты и прогнозы без команды дата-инженеров.",
    tags: ["Next.js", "LangChain", "PostgreSQL", "Chart.js"],
    icon: BarChart3,
    accent: "#e8927c",
  },
  {
    id: "launchpro",
    title: "LaunchPro",
    description: "Лендинг для продукта, собранный за 48 часов. Конверсия 12 % с первой недели запуска и полная адаптивность.",
    tags: ["Framer Motion", "Figma", "TypeScript", "Vite"],
    icon: Rocket,
    accent: "#1a2420",
  },
];
