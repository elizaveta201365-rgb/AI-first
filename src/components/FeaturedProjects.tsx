...
const projects = [
  {
    id: "wedding-invite",
    title: "Wedding Invite — цифровые приглашения",
    description: "Создаю современные цифровые приглашения с анимацией, таймером, картой, RSVP-формой и персональным дизайном. Готовый сайт за 1–2 дня.",
  ...
  {
    id: "landing-pro",
    title: "Landing Pro — лендинги для онлайн-школ",
    description: "Разрабатываю посадочные страницы, которые помогают продавать курсы, вебинары и наставничество. Адаптивный дизайн, быстрый запуск и интеграции.",
  ...
  {
    id: "ai-automation",
    title: "AI Automation — AI-ассистенты и автоматизация бизнеса",
    description: "Создаю AI-сервисы: чат-ботов, генераторы контента, CRM-помощников, формы с искусственным интеллектом и внутренние инструменты автоматизации.",
    tags: ["OpenAI", "LangChain", "Python", "PostgreSQL"],
    icon: Rocket,
    accent: "#1a2420",
  },
];
